class HotelRoom {
  ...
  List<HotelRoom> hotels = [
    HotelRoom(
      ...
      description:
          "A cozy and modern room designed for comfort with all essential amenities for a relaxing stay.", id: '1',
    ),
    ...
    HotelRoom(
      ...
      description:
          "Spacious suite with premium workspace and modern facilities, perfect for work and relaxation.", id: '2', 
    ),
    ...
    HotelRoom(
      ...
      description:
          "A spacious suite designed for families with comfort, space, and convenience.", id: '3',
    ),
    ...
    HotelRoom(
      ...
      description:
          "Experience premium luxury with elegant interiors and top-class amenities.", id: '4',
    ),
    ...
    HotelRoom(
      ...
      description:
          "A simple and affordable room with all basic facilities for a comfortable stay.", id: '5',
    ),
  ];
